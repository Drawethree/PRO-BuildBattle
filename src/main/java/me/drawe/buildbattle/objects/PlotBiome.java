...
public enum PlotBiome {
    ...
    MESA("Mesa", Biome.MESA, ItemCreator.create(Material.STAINED_CLAY, 1, (byte) 1, Message.GUI_BIOMES_MESA_DISPLAYNAME.getMessage(), ItemCreator.convertLore(BuildBattle.getFileManager().getConfig("messages.yml").get().getStringList("gui.biomes.items.mesa.lore")), null, null), 1),
    ...
    FOREST("Forest", Biome.FOREST, ItemCreator.create(Material.LOG, 1, (byte) 0, Message.GUI_BIOMES_FOREST_DISPLAYNAME.getMessage(), ItemCreator.convertLore(BuildBattle.getFileManager().getConfig("messages.yml").get().getStringList("gui.biomes.items.forest.lore")), null, null), 4),
    ...
    SWAMP("Swamp", Biome.SWAMPLAND, ItemCreator.create(Material.WATER_LILY, 1, (byte) 0, Message.GUI_BIOMES_SWAMP_DISPLAYNAME.getMessage(), ItemCreator.convertLore(BuildBattle.getFileManager().getConfig("messages.yml").get().getStringList("gui.biomes.items.swamp.lore")), null, null), 6),
    SAVANNA("Savanna", Biome.SAVANNA, ItemCreator.create(Material.LOG_2, 1, (byte) 0, Message.GUI_BIOMES_SAVANNA_DISPLAYNAME.getMessage(), ItemCreator.convertLore(BuildBattle.getFileManager().getConfig("messages.yml").get().getStringList("gui.biomes.items.savanna.lore")), null, null), 7);
