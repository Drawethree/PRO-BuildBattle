...
public enum BBParticle {
    ...
    GLYPH(ParticleEffect.ENCHANTMENT_TABLE, ItemCreator.create(Material.LEGACY_ENCHANTMENT_TABLE,1,(byte) 0, "&aGlyph particle", ItemCreator.makeLore("&7Right-Click to place."), null,null),16),
    ...
    MOB_SPAWNER(ParticleEffect.FLAME, ItemCreator.create(Material.LEGACY_MOB_SPAWNER,1,(byte) 0, "&aMobspawner particle", ItemCreator.makeLore("&7Right-Click to place."), null,null),20),
    ...
    SPLASH(ParticleEffect.WATER_SPLASH, ItemCreator.create(Material.LEGACY_BOAT,1,(byte) 0, "&aSplash particle", ItemCreator.makeLore("&7Right-Click to place."), null,null),24),
    ...
    PORTAL(ParticleEffect.PORTAL, ItemCreator.create(Material.LEGACY_NETHER_BRICK_ITEM,1,(byte) 0, "&aPortal particle", ItemCreator.makeLore("&7Right-Click to place."), null,null),29),
    FIREWORK_SPARK(ParticleEffect.FIREWORKS_SPARK, ItemCreator.create(Material.LEGACY_FIREWORK,1,(byte) 0, "&aFirework Spark particle", ItemCreator.makeLore("&7Right-Click to place."), null,null),30),
    ...
    SNOWBALL_POOF(ParticleEffect.SNOWBALL, ItemCreator.create(Material.LEGACY_SNOW_BALL,1,(byte) 0, "&aSnowball Poof particle", ItemCreator.makeLore("&7Right-Click to place."), null,null),32);
