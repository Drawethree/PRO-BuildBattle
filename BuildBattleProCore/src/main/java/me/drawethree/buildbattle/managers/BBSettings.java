...
public class BBSettings {
    ...
    private boolean showBuildersNames;
    ...
    private void setShowBuildersNames(boolean b) {
        this.showBuildersNames = b;
    }
